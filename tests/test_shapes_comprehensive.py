...
class TestSquare:
  ...
  def test_square_with_notches(self):
    ...
    square = Square(
      side=1.0,
      notch_sides=[OrdinalEnum.SOUTH, OrdinalEnum.NORTH],
      notch_size=0.2,
      notch_depth=0.1
    )
    vertices = square.build_shape()
...
class TestShapeFactory:
  ...
  def test_create_from_legacy_square(self):
    ...
    shape = ShapeFactory.create_from_legacy(
  ...
  def test_create_from_legacy_trapezoid_variants(self):
    ...
    right = ShapeFactory.create_from_legacy(
      ...
      {'w1': 1.0, 'w2': 0.6, 'h': 0.8, 'side_left': 0.8}
    )
    ...
    general = ShapeFactory.create_from_legacy(
      ...
      {'w1': 1.0, 'w2': 0.6, 'h': 0.8, 'side_left': 1.2}
    )
  ...
  def test_legacy_parameter_mapping(self):
    ...
    kite = ShapeFactory.create_from_legacy(
      QuadShapeEnum.KITE,
      {'d1': 1.0, 'd2': 0.6}
    )
